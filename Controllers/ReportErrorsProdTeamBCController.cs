...
{
    public class ReportErrorsProdTeamBCController : ControllerBase
    {
        /// <summary>
        /// Ошибки Prod команд B и C
        /// </summary>
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("errorsProdTeamBC")]
        public PlotSet errorsProdTeamBC(DateTime startDate, int stepBacklogTime, int stepLeadTime)
        {
            ...
            using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
            {
                string ErrorsProdTeamBC =
                    ...
                    @"[System.AreaPath] = 'Tele2\\CRM\\CRM Team C') and " +
                ...
                streamWriter.Write(ErrorsProdTeamBC);
                streamWriter.Flush();
                streamWriter.Close();
            }
