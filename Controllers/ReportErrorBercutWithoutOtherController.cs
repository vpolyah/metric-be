...
{
    public class ReportErrorBercutWithoutOtherController : ControllerBase
    {
        /// <summary>
        /// Bercut - ошибки без тега Other
        /// </summary>
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("errorBercutWithoutOther")]
        public PlotSet errorBercutWithoutOther(DateTime startDate, int stepBacklogTime, int stepLeadTime)
        {
            ...
            {
                string ErrorBercutWithoutOther =
                    "{" + "\"query\":" + "\"" +
                    "select [System.Id], " +
                    "[System.CreatedDate], " +
                    ...
                    "[System.Tags], " +
                    "[System.Reason] from WorkItems where " +
                    "[System.TeamProject] = @project and " +
                    "([System.WorkItemType] = 'Ошибка' and [System.CreatedBy] in " +
                    ...
                    "not [System.Tags] contains 'Other' or " +
                    ...
                    "\"" +
                    "}";
                streamWriter.Write(ErrorBercutWithoutOther);
                streamWriter.Flush();
                streamWriter.Close();
            }
