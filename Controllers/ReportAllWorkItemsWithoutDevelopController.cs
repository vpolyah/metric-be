...
{
    public class ReportAllWorkItemsWithoutDevelopController : ControllerBase
    {
        /// <summary>
        /// Требования без разработки
        /// </summary>
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("allWorkItemsWithoutDevelop")]
        public PlotSet allWorkItemsWithoutDevelop(DateTime startDate, int stepBacklogTime, int stepLeadTime)
        {
            ...
            {
                string AllWorkItemsWithoutDevelop =
                    "{" + "\"query\":" + "\"" +
                    "select [System.Id], " +
                    "[System.CreatedDate], " +
                ...
                streamWriter.Write(AllWorkItemsWithoutDevelop);
                streamWriter.Flush();
                streamWriter.Close();
            }
